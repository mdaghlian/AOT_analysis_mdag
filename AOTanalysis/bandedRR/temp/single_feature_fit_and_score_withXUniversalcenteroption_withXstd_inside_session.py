...
def fit_split(
    ...
    def test_and_score(savedir, model):
        ...
        save_name = f"R2_score_single_sub{sub}_{feature}_train_{ses}_testinside.nii.gz"
    ...
    model_path = (
        path / f"model_sub{sub}_feature_{feature}_trainses_{ses}_testinside.joblib"
    )
...
if __name__ == "__main__":
    for sub in [1, 2, 3]:
        ...
        fit_split(sub, train_ses, gpu=gpu, feature="semantic")
