...
def fit_split(
    ...
    gpu=True,
    direction="fw",
    save_dir="/tank/shared/2024/visual/AOT/temp/bandedRR_split_single_feature_withSTD",
):
    ...
    def test_and_score(savedir, model):
        ...
        if not os.path.exists(savedir):
            os.makedirs(savedir)
        generalscoreimg = nib.Nifti1Image(
            general_score_reshape, affine=affine, header=header
        )
