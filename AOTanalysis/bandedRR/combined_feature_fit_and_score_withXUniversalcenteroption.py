...
# the version that features X is centered by average of all feature data
...
def data_construct(
    ...
    for feature_name in feature_names:
        ...
        elif feature_name == "sbert_PCA_all":
            X = construct_features_sbert_embeddings_PCA(
                video_index, centered=Xcentered, component_index="all"
            )
        # elif feature_name == "sbert_PCA_0":
        #     X = construct_features_sbert_embeddings_PCA(
        #         video_index, centered=centered, component_index=0
        #     )
        # elif feature_name == "sbert_PCA_1":
        #     X = construct_features_sbert_embeddings_PCA(
        #         video_index, centered=centered, component_index=1
        #     )
        # elif feature_name == "sbert_PCA_2":
        #     X = construct_features_sbert_embeddings_PCA(
        #         video_index, centered=centered, component_index=2
        #     )
        # elif feature_name == "sbert_PCA_3":
        #     X = construct_features_sbert_embeddings_PCA(
        #         video_index, centered=centered, component_index=3
        #     )
        # elif feature_name == "sbert_PCA_4":
        #     X = construct_features_sbert_embeddings_PCA(
        #         video_index, centered=centered, component_index=4
        #     )
    ...
    for split_index in range(n_splits):
        for direction in ["fw", "rv"]:
            fit_split(
                ...
                feature_names=["motion_energy", "semantic_embeddings"],
                direction=direction,
                save_dir="/tank/shared/2024/visual/AOT/temp/bandedRR_split_motion_sbert768_Xprecentered",
            )
        break
